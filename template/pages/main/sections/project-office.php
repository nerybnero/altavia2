            ...
            <div class="project-office__bottom">
                <div class="project-office__cards">
                    <article class="project-office__card">
                        ...
                        <p class="project-office__card-desc">Мы возьмем на себя весь блок бизнес-процессов в переходный
                    ...
                    <article class="project-office__card">
                        ...
                        <p class="project-office__card-desc">Сопровождение любого проекта с этапа зарождения. Поможем
                    ...
                    <article class="project-office__card">
                        ...
                        <p class="project-office__card-desc">Поможем найти компромисс в критический для бизнеса момент
                    ...
                    <article class="project-office__card hidden-card">
                        ...
                        <p class="project-office__card-desc">Команда из юристов, финансистов, бухгалтеров и специалистов
                    ...
                    <article class="project-office__card hidden-card">
                        ...
                        <p class="project-office__card-desc">Комплексный анализ уже состоявшегося бизнеса, в который вы
